 ...
 *
 * Пакетного режима нет: в 26.2 присед передаётся флагами в пакетах
 * перемещения, а не отдельным ServerboundPlayerActionPacket — «тихий
 * присед» без замедления на этом протоколе невозможен.
 */
