...
public final class ClickGuiScreen extends Screen {
	...
	private String label(String k){return switch(k){case"x","y","z"->"Координата "+k.toUpperCase();case"axis"->"Ось: x / y / z";case"block"->"ID блока";case"item"->"ID предмета";case"count"->"Количество";case"slot"->"Слот / слот хотбара";case"from"->"Из слота меню";case"to"->"В слот меню";case"amount"->"one / stack";case"delay_ticks"->"Пауза между кликами";case"food"->"ID еды или any";case"state"->"Состояние: open / closed";case"restore_slot"->"Вернуть слот: true / false";case"mode"->"Режим сопоставления";case"yaw"->"Yaw";case"pitch"->"Pitch";case"direction"->"forward / back / left / right";case"swings"->"Количество ударов";case"hand"->"Рука: main / off";case"entity"->"Тип сущности";case"radius"->"Радиус";case"message"->"Сообщение";case"pattern"->"Фрагмент или regex";case"timeout"->"Таймаут, сек.";case"seconds"->"Секунды";case"command"->"Команда чата";case"name"->"Имя / переменная";case"flag"->"Имя флага";case"value"->"Значение";case"left"->"Левая часть";case"operator"->"Оператор: == != > >= < <= contains";case"right"->"Правая часть";default->k;};}
