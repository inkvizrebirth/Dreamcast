...
public final class ClickGuiScreen extends Screen {
	...
	private void drawEditor(GuiGraphicsExtractor g,int mx,int my){
		top(g,"Конструктор автоматизации");Box back=new Box(14,12,58,24),corner=new Box(width-568,12,82,24),marker=new Box(width-478,12,82,24),region=new Box(width-388,12,80,24),add=new Box(width-300,12,78,24),save=new Box(width-214,12,76,24),run=new Box(width-130,12,72,24),stop=new Box(width-52,12,38,24);
